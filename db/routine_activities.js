...
//create Routine_Activity CREATED 5/19 FOR A POST
async function createRoutineActivity({
  ...
  try {
    const {
      ...
      `
      INSERT INTO routine_activities(id, routineId, activityId, duration, count) VALUES ($1, $2, $3, $4,$5)
